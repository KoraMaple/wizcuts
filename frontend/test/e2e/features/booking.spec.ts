...
test.describe('Booking System', () => {
  ...
  test('should display booking interface elements', async ({ page }) => {
    ...
    const hasBookingContent =
      pageText?.toLowerCase().includes('book') ||
  ...
  test('should handle booking form interaction (if present)', async ({
    page,
  }) => {
  ...
  test('should display service information', async ({ page }) => {
    ...
    const hasServiceContent =
      pageText?.toLowerCase().includes('haircut') ||
  ...
  test('should display pricing information (if available)', async ({
    page,
  }) => {
