    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 flex items-center justify-center p-4">
      <div className="w-full max-w-md">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-slate-300 text-lg">Continue to book your appointment</p>
        </div>
        ...
        <div className="bg-charcoal/50 backdrop-blur-sm border border-slate-600/20 rounded-2xl p-8 shadow-2xl">
          <div className="text-center mb-6">
            ...
            <p className="text-slate-400">Choose your preferred method to continue</p>
          </div>
        ...
        <div className="text-center mt-8">
          <p className="text-slate-400 text-sm">
            ...
            and{' '}
            <a href="/privacy" className="text-gold hover:text-gold/90 underline">
              Privacy Policy
            </a>
          </p>
        </div>
